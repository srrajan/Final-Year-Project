...
<div class="header">
  <a href="#default" class="logo"><img class="logo" src="logoblood.png"></a>
...
<div style="max-width:100%">
  <img class="mySlides"  src="myslide1.png" >
  <img class="mySlides"  src="myslide2.jpg" >
</div>
<script>
var myIndex = 0;
carousel();
...
<body>
  ...
  {
	  %>
	  <center><font color="red" size="5">Form Submitted Successfully,You will get notified soon.</font></center>
	  <% 
  }
  %>
  <%
 ...
 <center><h1>Enter Your Details For Blood</h1></center>
